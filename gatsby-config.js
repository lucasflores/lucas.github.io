module.exports = {
  siteMetadata: {
    ...
    social: {
      ...
      facebook: ``,
      github: `lucasflores`,
      linkedin: `lucas-m-flores`,
      email: `lucasmacrorieflores@gmail.com`,
    },
  },
  plugins: [
    {
      ...
      options: {
        shortname: `lucasflores-github-io`
      }
    },
    {
    ...
    // },
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `./static/favi.png`, // This path is relative to the root of the site.
      },
    },
