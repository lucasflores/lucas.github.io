...
const AboutMePage = ({ data }) => {
  return (
    <Layout>
	  ...
	  <p>My name is Lucas Flores and I a have PhD in experimental elementary particle physics from the the University of Pennsylvania. In my PhD work I searched for new never before seen fundamental particles by analyzing large sets of real and simulated proton proton collision data using strong statistical likelihood techniques. This work was done as a part of the  ATLAS experiment, a massive particle detector that sits along the  Large Hadron Collider (LHC) at  CERN located near Geneva, Switzerland, where I spent 3+ years living and working. Outside of work I like to make things (in code and of atoms), take photos, listen to podcasts about the nature of the mind, and to never speak in absolutes. Check out the blogfolio section to see some of the things I have made over the years.</p>
