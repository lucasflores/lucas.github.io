...
int main()
{
  ...
  string d0 = dates.front();
  string d6 = dates.back();
  ...
  string t0 =  d0.substr(0,2);
  string t02 = d0.substr(3,2);
  d0.replace(0,2, t02);
  d0.replace(3,2, t0);

  string t1 =  d1.substr(0,2);
  string t12 = d1.substr(3,2);
  d1.replace(0,2, t12);
  d1.replace(3,2, t1);

  string t2 =  d2.substr(0,2);
  string t22 = d2.substr(3,2);
  d2.replace(0,2, t22);
  d2.replace(3,2, t2);

  string t3 =  d3.substr(0,2);
  string t32 = d3.substr(3,2);
  d3.replace(0,2, t32);
  d3.replace(3,2, t3);

  string t4 =  d4.substr(0,2);
  string t42 = d4.substr(3,2);
  d4.replace(0,2, t42);
  d4.replace(3,2, t4);

  string t5 =  d5.substr(0,2);
  string t52 = d5.substr(3,2);
  d5.replace(0,2, t52);
  d5.replace(3,2, t5);

  string t6 =  d6.substr(0,2);
  string t62 = d6.substr(3,2);
  d6.replace(0,2, t62);
  d6.replace(3,2, t6);
  ...
  paintText(0.11, 0.07, 30, 0.032, d0.c_str());
  ...
  paintText(0.90, 0.07, 30, 0.032, d6.c_str());
